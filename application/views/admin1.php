...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>Bootstrap 3 Admin Example</title>
		<meta name="generator" content="Bootply" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		
    <?php
    //Bootstrap core, Bootstrap theme, bootstrap selectors personalizados
    echo link_tag('files/admin1/css/bootstrap.min.css');
    echo link_tag('files/admin1/css/styles.css');
    ?>
		<!--[if lt IE 9]>
...
<div class="modal" id="addWidgetModal">
  <div class="modal-dialog">
    ...
    <?php 
    //funciones personalizadas, bootstrap selectores personalizados
    echo '<script src="';
    echo base_url("files/admin1/js/bootstrap.min.js") . '"></script>' ;
    echo '<script src="';
    echo base_url("files/admin1/js/scripts.js") . '"></script>' ;
    ?>
	</body>
</html>