...
class Ventas_model extends Generic_model{
	...
	{
		$this->db->select('ventas.id,productos.nombre as producto,tipoproducto.nombre as tipo,usuario.nombre as usuario ,lugar.nombre as lugar, importe as precio,fecha, cantidad, importe as total');
		$this->db->from('ventas');
