    ...
    <div class="row mt">
      ...
      <div class="col-lg-12">
        <div class="form-panel">
         <form class="form-horizontal style-form" method="post" action=<?php echo '"' . site_url("/productos/resta_asignacion") . '"' ?>>
          ...
          <div class="form-group">
           ...
           <button type="submit" class="btn btn-round btn-primary">Quitar</button>&nbsp&nbsp&nbsp
