<section id="main-content">
	<section class="wrapper site-min-height">
		<h3><i class="fa fa-angle-right"></i>Registrar Gasto</h3>
		<div class="row mt">
			...
			<div class="col-lg-12">
				<div class="form-panel">
					...
					<?php if(!isset($gasto)): ?>
						...
						<?php else: ?>
							<form name="gasto-form" class="form-horizontal style-form" method="post" action="<?php echo base_url('gastos/actualizar')?>">

							<?php endif;?>
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">Tipo</label>
								<div class="col-md-5">
									<select name="idTipoGasto" class="form-control" required value="<?php if (isset($gasto)) echo $gasto['idTipo']; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-2">
									<input value="<?php if (isset($gasto)) echo $gasto['cantidad']; ?>" type="text" name="cantidad" class="form-control" min="0" maxlength="20">
								</div>
							</div>
							<div class="form-group">
