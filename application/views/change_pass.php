	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" method="post" action=<?php echo '"' . site_url("/sesion/iniciar") . '"' ?>>
		        ...
		        <div class="login-wrap">
		            ...
		            <br>
		            <input type="pass2.1" name="clave" class="form-control" placeholder="Contraseña Nueva" required>
		            <br>
		            <input type="pass2.2" name="clave" class="form-control" placeholder="Contraseña Nueva" required>
